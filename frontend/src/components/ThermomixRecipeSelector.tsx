    ...
    <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 rounded-3xl border-2">
      <div className="aspect-video relative overflow-hidden">
        ...
        <div className="absolute bottom-3 left-3 bg-white/90 px-2 py-1 rounded-full">
          <span className="text-xs font-medium text-gray-700">{recipe.phases.length} phases</span>
        </div>
      ...
      <div className="p-6 space-y-4">
        <div className="flex items-start justify-between">
          <h3 className="text-xl font-medium text-gray-800 leading-tight">{recipe.name}</h3>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="text-right">
            <div className="text-lg font-bold text-orange-600">{recipe.phases[0]?.temperature}°C</div>
