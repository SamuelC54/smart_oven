...
export function ThermomixRecipeSelector({ onSelectRecipe, onViewRecipe, onBack }: ThermomixRecipeSelectorProps) {
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {filteredRecipes.length === 0 && (
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-gray-600 mb-1">No recipes found</h3>
      ...
      <div className="flex gap-3 p-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between mb-1">
            <h3 className="font-medium text-gray-800 text-sm leading-tight truncate pr-2">{recipe.name}</h3>
          ...
          <div className="flex items-center gap-3 text-gray-600 mb-2">
            ...
            <Badge className={`${getDifficultyColor(recipe.difficulty)} border text-xs px-1.5 py-0.5`}>
              {recipe.difficulty}
            </Badge>
          </div>
