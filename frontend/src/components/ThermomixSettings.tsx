      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-medium text-gray-800">Oven Settings</h1>
          </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-8 rounded-3xl border-2 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-medium text-gray-800">Cooking Mode</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-6 rounded-3xl border-2 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-medium text-gray-800">Temperature</h3>
              </div>
              
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <span className="text-gray-700 font-medium">Temperature Unit</span>
                  <Select 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-gray-700 font-medium">Auto Preheat</span>
                    <p className="text-sm text-gray-500">Start heating automatically</p>
                  </div>
                  <Switch
            ...
            <Card className="p-6 rounded-3xl border-2 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-medium text-gray-800">Fan Control</h3>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-lg font-bold text-blue-600">{settings.fanSpeed}%</span>
                  </div>
                  <Slider
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-6 rounded-3xl border-2 shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-gray-700 font-medium">Alert Sounds</span>
                    <p className="text-sm text-gray-500">Cooking completion alerts</p>
                  </div>
                  <Switch
                ...
                {settings.alertSound && (
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="text-lg font-bold text-green-600">{settings.alertVolume}%</span>
                    </div>
                    <Slider
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-lg font-bold text-yellow-600">{settings.brightness}%</span>
                  </div>
                  <Slider
          ...
          <Card className="p-6 rounded-3xl border-2 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-medium text-gray-800">Safety & Control</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-gray-700 font-medium">Auto Shutoff</span>
